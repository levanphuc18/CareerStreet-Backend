package com.careerstreet.apigateway.filter;
import com.careerstreet.apigateway.jwt.JwtHelper;
...
public class JwtRoleAuthenticationFilter implements GatewayFilter{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        try {
            ...
            if (roles.contains("admin") || roles.contains("employer") || roles.contains("candidate")) {
